...
INSERT INTO Categories (category_id, name, description, icon, highlighted) VALUES (3, 'Mobile Phones', 'Smart Phones, Camera Phones, Music Phones, 3G Phones and Basic Phones', 'fa-mobile-alt', true);
